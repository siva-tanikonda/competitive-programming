...
for i in range(1, n + 1):
    ...
    os.system(fileBase + "_compiled < \"" + directoryBase + "\\input.txt\" > " + fileBase + "_output.txt")
    os.system(fileBase + "_slow_compiled < \"" + directoryBase + "\\input.txt\" > " + fileBase + "_slow_output.txt")
