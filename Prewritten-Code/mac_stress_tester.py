...
os.system("g++ -std=c++17 -fdiagnostics-color=always -Wall -Wno-pragmas -Wno-attributes -o " + fileBase + "_generator " + fileBase + "_generator.cpp")
os.system("g++ -std=c++17 -fdiagnostics-color=always -Wall -Wno-pragmas -Wno-attributes -o " + fileBase + " " + fileBase + ".cpp")
os.system("g++ -std=c++17 -fdiagnostics-color=always -Wall -Wno-pragmas -Wno-attributes -o " + fileBase + "_slow " + fileBase + "_slow.cpp")
